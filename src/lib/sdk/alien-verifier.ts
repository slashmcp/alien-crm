/**
 * AlienVerifier SDK
 * Ultra-fast email verification SDK for autonomous AI agents and B2B pipelines.
 */
...
export class AlienVerifier {
  ...
  /**
   * Helper filter: Returns only emails that meet the minimum safe deliverability score
   */
